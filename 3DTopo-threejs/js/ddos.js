...
function ddosAttack(){
	...
	$(".wai").append($_div);
	// 画出受到ddos攻击的设备
	topo.drawDDosDevice(node.deviceId);
	// 找出链路
        ...
        if(reportOfDevice.DDosParams.nodeIndex==reportOfDevice.DDosParams.nodes.length-1){
            ...
            setTimeout(function(){
            	...
            	setTimeout(function(){
                    ...
                    $("#repair-info").after("<a id='repair-start' class='repair_buttom' href='javascript:repair(0,\""+n.deviceId+"\");'>开始修复</a>");
